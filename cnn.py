...
from keras._tf_keras.keras.layers import Activation, Conv2D
...
from keras._tf_keras.keras.layers import SeparableConv2D
...
if __name__ == "__main__":
    ...
    # model.summary()
    model = mini_XCEPTION((64, 64, 1), num_classes)
    model.summary()
